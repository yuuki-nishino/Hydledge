<template>
  <v-container fluid class="hard-pref">
    <div class="text-h3 my-3 mt-8 font-weight-bold primary--text">
      {{ $route.query.prefName }} の硬度データ
    </div>
    <v-section>
      <div class="text-h4 mt-8 font-weight-bold primary--text">
        硬度区分マップ
      </div>
          ...
          <v-row justify="center" class="my-3">
            <v-card elevation="1">
              <v-simple-table>
                <thead>
                  <tr>
                    <th class="text-h7" style="text-align: center">アイコン</th>
                    <th class="text-h7" style="text-align: center">硬度範囲</th>
                    <th class="text-h7" style="text-align: center">アイコン</th>
                    <th class="text-h7" style="text-align: center">硬度範囲</th>
                  </tr>
                </thead>
    ...
    <v-row class="my-3">
      <v-col cols="6">
        <v-card height="250">
          <GChart :type="HistoType" :data="chartData" :options="HistOptions" />
        </v-card>
        <v-card height="250">
          <GChart
            :type="ColumnType"
...
import PrefData from '@/assets/mockup_data/HardnessData/NaganoHardness.json'
...
export default {
  ...
  methods: {
    ...
    setTitle() {
      ...
      this.ColumnOptions.title = this.pref + this.ColumnOptions.title
    },
    setMap() {
